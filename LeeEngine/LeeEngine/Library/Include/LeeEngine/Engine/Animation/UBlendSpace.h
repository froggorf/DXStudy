...
public:
	...
	inline static const std::shared_ptr<UBlendSpace>& GetAnimationAsset(const std::string& AnimationName){return std::dynamic_pointer_cast<UBlendSpace>(UAnimationAsset::GetAnimationAsset(AnimationName));}
