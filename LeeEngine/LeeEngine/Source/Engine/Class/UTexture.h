...
class UTexture : public UObject
{
	...
	const Microsoft::WRL::ComPtr<ID3D11Texture2D>& GetTexture() const {return Texture2D; }
	const Microsoft::WRL::ComPtr<ID3D11ShaderResourceView>& GetSRV() const { return SRView; }
	const Microsoft::WRL::ComPtr<ID3D11RenderTargetView>& GetRTV() const { return RTView;}
	const Microsoft::WRL::ComPtr<ID3D11DepthStencilView>& GetDSV() const { return DSView; }
	const Microsoft::WRL::ComPtr<ID3D11UnorderedAccessView>& GetUAV() const { return UAView; }
